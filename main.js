...
var sketch_drawn = quick_draw_data_set[random_no]
console.log(sketch_drawn)
var timer_counter = 0;
var timer_check = "";
var drawn_skecth = "";
var answer_holder = "";

document.getElementById("sketch_drawn").innerHTML = "Sketch to be Drawn:  " +sketch_drawn

function setup() {
    canvas = createCanvas(400, 400);
    canvas.center();
    canvas.mouseReleased(classisfyCanvas);
